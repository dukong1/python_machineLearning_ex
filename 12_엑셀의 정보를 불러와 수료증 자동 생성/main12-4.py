...
load_wb = load_workbook(r"12_엑셀의 정보를 불러와 수료증 자동 생성\수료증명단.xlsx")
...
for i in range(len(name_list)):
    doc = docx.Document(r'12_엑셀의 정보를 불러와 수료증 자동 생성\수료증양식.docx')
    ...
    doc.save('12_엑셀의 정보를 불러와 수료증 자동 생성\\'+name_list[i]+'.docx')
    convert('12_엑셀의 정보를 불러와 수료증 자동 생성\\'+name_list[i]+'.docx',
            '12_엑셀의 정보를 불러와 수료증 자동 생성\\'+name_list[i]+'.pdf')
